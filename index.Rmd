...
```
The output of this analysis gave us insight into the sentiment of the media, national governments, as well as the private sector. Obviously, an article from Bloomberg is going to be more likely to contain the words 'inflation' 'market' or 'economy' than an Emily Dickinson Poem, but seeing the other words that also appear frequently and viewing the output holistically still gives us a unique takeaway. That is: among all these economy related terms - oil also appears frequently in relation. 
